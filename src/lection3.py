...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        # Заголовок
        self.label_2 = QtWidgets.QLabel("Лекция №3. Динамические структуры данных", Dialog)
        ...
        # Кнопки
        self.pushButton = QtWidgets.QPushButton("Введение", self.frame_2)
        self.pushButton_2 = QtWidgets.QPushButton("Линейные списки", self.frame_2)
        self.pushButton_6 = QtWidgets.QPushButton("Стеки", self.frame_2)
        self.pushButton_3 = QtWidgets.QPushButton("Очереди", self.frame_2)
