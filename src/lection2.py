...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        # Заголовок
        self.label_2 = QtWidgets.QLabel("Лекция №2. Базовые конструкции структурного программирования", Dialog)
        ...
        # Кнопки
        self.pushButton = QtWidgets.QPushButton("Оператор 'выражение' и условный оператор if", self.frame_2)
        self.pushButton_2 = QtWidgets.QPushButton("Цикл с предусловием (while) и (do while)", self.frame_2)
        self.pushButton_6 = QtWidgets.QPushButton("Цикл с параметром (for)", self.frame_2)
        self.pushButton_3 = QtWidgets.QPushButton("Оператор switch", self.frame_2)
