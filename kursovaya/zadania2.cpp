    ...
    , ui(new Ui::zadania2)
{
    ...
    connect(ui->AnswerA, &QRadioButton::toggled, this, &zadania2::updateSubmitButtonState);
    connect(ui->AnswerB, &QRadioButton::toggled, this, &zadania2::updateSubmitButtonState);
    connect(ui->AnswerC, &QRadioButton::toggled, this, &zadania2::updateSubmitButtonState);
    connect(ui->AnswerD, &QRadioButton::toggled, this, &zadania2::updateSubmitButtonState);

    // Подключаем слоты для радиокнопок второй группы
    connect(ui->AnswerA_2, &QRadioButton::toggled, this, &zadania2::updateSubmitButtonState);
    connect(ui->AnswerB_2, &QRadioButton::toggled, this, &zadania2::updateSubmitButtonState);
    connect(ui->AnswerC_2, &QRadioButton::toggled, this, &zadania2::updateSubmitButtonState);
    connect(ui->AnswerD_2, &QRadioButton::toggled, this, &zadania2::updateSubmitButtonState);

    // Подключаем слоты для радиокнопок третьей группы
    connect(ui->AnswerA_3, &QRadioButton::toggled, this, &zadania2::updateSubmitButtonState);
    connect(ui->AnswerB_3, &QRadioButton::toggled, this, &zadania2::updateSubmitButtonState);
    connect(ui->AnswerC_3, &QRadioButton::toggled, this, &zadania2::updateSubmitButtonState);
    connect(ui->AnswerD_3, &QRadioButton::toggled, this, &zadania2::updateSubmitButtonState);
...
void zadania2::updateButtonsVisibility() {
    ...
    bool secondGroupCorrect = ui->AnswerA_2->isChecked(); // AnswerA_2 - правильный ответ второй группы
    bool thirdGroupCorrect = ui->AnswerA_3->isChecked(); // AnswerA_3 - правильный ответ второй группы
    ...
    if (ui->AnswerA_2->isChecked()) {
        ui->AnswerA_2->setStyleSheet("background-color: green;"); // Правильный ответ
    }
    if (ui->AnswerB_2->isChecked()) {
        ui->AnswerB_2->setStyleSheet("background-color: red;"); // Неправильный ответ
    }
    if (ui->AnswerC_2->isChecked()) {
        ui->AnswerC_2->setStyleSheet("background-color: red;"); // Неправильный ответ
    }
    ...
    if (ui->AnswerA_3->isChecked()) {
        ui->AnswerA_3->setStyleSheet("background-color: green;"); // Правильный ответ
    }
    ...
    if (ui->AnswerD_3->isChecked()) {
        ui->AnswerD_3->setStyleSheet("background-color: red;"); // Неправильный ответ
    }
...
void zadania2::on_backButton_clicked() { // Реализация слота для кнопки "Вернуться на главную"
